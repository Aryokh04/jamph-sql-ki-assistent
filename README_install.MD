...
## Student Umami Module (This procject contains a local version of UMAMI Student edition)
   umami-start-student
...
Copy the 'createfakeuser.env' file to set the MOCK_NAV_IDENT variable to your desired ident, store as .env.

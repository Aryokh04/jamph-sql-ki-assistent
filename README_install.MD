...
- **Jamph Frontend**: https://jamph-umami-frontend.researchops.nav.no
- **Jamph RAG API**: https://jamph-rag-api-umami.researchops.nav.no
- **Jamph Ollama**: https://jamph-ollama.researchops.nav.no
